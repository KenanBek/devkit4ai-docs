...
- **Subscription Billing:** Checkout flows, billing management, and customer portal
...
<CardGroup cols={2}>
  ...
  <Card title="Add Billing" icon="credit-card" href="/starter-kit/features/payments">
    Implement subscription billing for your users
  </Card>
