---
title: "Introduction"
description: "Welcome to the developer documentation for Dev Kit for AI"
---

## Getting Started

Get your project application up and running in minutes.
...
<Columns cols={2}>
  ...
  <Card title="API documentation" icon="terminal" href="/cloud-api/introduction">
