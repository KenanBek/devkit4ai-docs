...
<Info>
**Prerequisites:** Node.js 19 or later, a GitHub account, and access to the hosted Cloud Admin at `https://devkit4ai.com/console` or `https://vibecoding.ad/console`.
</Info>
...
<Steps>
  <Step title="Create a developer workspace">
    Visit `https://devkit4ai.com/register/developer` (or the `vibecoding.ad` equivalent) and complete the registration flow. The backend automatically provisions your developer account, default project, and API credentials as soon as the confirmation succeeds.
  </Step>
