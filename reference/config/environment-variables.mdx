...
**Value:** Your project API key from Cloud Admin (starts with `pk_`)

**Description:** Scopes API requests to your specific project.

```bash
DEVKIT4AI_PROJECT_KEY=pk_abcdef1234567890abcdef1234567890
```
...
docker run -e DEVKIT4AI_MODE=project \
  ...
  -e DEVKIT4AI_DEVELOPER_KEY=dk_key \
  -e DEVKIT4AI_PROJECT_ID=uuid \
  -e DEVKIT4AI_PROJECT_KEY=pk_key \
  your-image
```
